# Generated by Django 5.1.3 on 2024-12-25 12:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('itemData', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.itemdata')),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('portfolio', models.ManyToManyField(to='app.portfolioitem')),
            ],
            options={
                'verbose_name': 'user',
